...
if __name__ == "__main__":
    main()
    # python src/enrichments_and_filters/filter_failed_hop_support.py --hop_support data/processed/hop_support.jsonl --hop_discovery data/raw/wikidata_ontology.hop_discovery_run2.json --out data/processed/hop_discovery_failed_only_trial.jsonl
